...
func ShowTrainingInfo(action int, trainingType string, duration, weight, height float64, lengthPool, countPool int) string {
	...
	case trainingType == "Плавание":
		distance := swimmingDistance(action)                                       // !!! Я создал новую функцию, т.к. обычная distance не учитывает длину одного гребка
...
// Параметры:
//
// action int — количество совершенных гребков при плавании.
