...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	...
	return (runningCaloriesMeanSpeedMultiplier * meanSpeed * runningCaloriesMeanSpeedShift) *
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	return (walkingCaloriesWeightMultiplier*weight + (math.Pow(meanSpeed, 2)/(height/cmInM))*
...
//func swimmingDistance(action int) float64 {
...
func SwimmingSpentCalories(lenghtPool, countPool int, duration, weight float64) float64 {
	swimmingMeanSpeed := swimmingMeanSpeed(lenghtPool, countPool, duration)
