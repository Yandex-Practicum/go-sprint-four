// ftracker - модуль, в котором описаны четыре экспортируемые функции —
// три для расчета расходуемых калорий для каждого вида тренировок
// и одна для вывода информации о тренировке.
// Остальные функции вспомогательные и неэкспортируемые.
// Все функции и константы в пакете подробно задокументированы
package ftracker
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	...
	result := (swimmingMeanSpeed(lengthPool, countPool, duration) + swimmingCaloriesMeanSpeedShift) * float64(swimmingCaloriesWeightMultiplier) * weight * duration
	return result
}
