...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	...
	meanSpeedPow := math.Pow(meanSpeed, 2)
	return ((walkingCaloriesWeightMultiplier*weight + (meanSpeedPow/(height/cmInM))*walkingSpeedHeightMultiplier*weight) * duration * minInH)
}
